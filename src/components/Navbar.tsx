...
export const Navbar = () => {
  return (
    <nav className="relative z-50 w-full">
      <div className="sticky top-0 text-sm container p-4 flex flex-col md:flex-row justify-between gap-8 items-center mx-auto">
        <Link
          className="flex items-center gap-2 bg-navButton py-1.5 px-2 rounded-[12px] text-bgInverse"
          href="http://sha.codes"
          target="_blank"
      ...
      <div className="hidden md:block absolute inset-x-0 top-full h-px bg-gradient-to-r from-transparent via-bgInverse to-transparent" />
    </nav>
  );
};
